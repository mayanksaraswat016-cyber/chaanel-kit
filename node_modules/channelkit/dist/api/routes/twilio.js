...
const twilio_1 = require("../../provisioning/twilio");
const twilio_2 = __importDefault(require("twilio"));
// Active SMS listeners keyed by phone number
const activeSmsListeners = new Map();
function registerTwilioRoutes(app, ctx) {
    app.post('/api/twilio/list-numbers', async (req, res) => {
        ...
        try {
            const provisioner = new twilio_1.TwilioProvisioner({ accountSid: account_sid, authToken: auth_token });
    ...
    app.post('/api/twilio/listen-sms', async (req, res) => {
        ...
        const client = (0, twilio_2.default)(account_sid, auth_token);
