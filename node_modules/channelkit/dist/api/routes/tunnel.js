...
exports.registerTunnelRoutes = registerTunnelRoutes;
const parser_1 = require("../../config/parser");
function registerTunnelRoutes(app, ctx) {
            ...
            for (const [name, ch] of Object.entries(config.channels)) {
                ...
                try {
                    ...
                    if (numbers.length > 0) {
                        ...
                        errors.push({ name, error: `Phone number ${ch.number} not found in Twilio` });
                    }
                }
                catch (err) {
