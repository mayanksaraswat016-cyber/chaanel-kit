...
function registerSettingsRoutes(app, ctx) {
    app.get('/api/settings', (_req, res) => {
        ...
        try {
            ...
            const dataStore = { type: config.data_store?.type || 'local' };
            if (config.data_store?.endpoint)
                dataStore.endpoint = config.data_store.endpoint;
            ...
            if (config.data_store?.sync_interval)
                dataStore.sync_interval = config.data_store.sync_interval;
    ...
    app.put('/api/settings', (req, res) => {
        ...
        try {
            ...
            if ('allow_local_webhooks' in req.body) {
                ...
                config.settings.allow_local_webhooks = val;
                (0, webhook_1.setAllowLocalWebhooks)(val);
            }
